...
TweenSpeed = ChangeSpeed or 325
end

DefualtY = P1.Y
TargetY = P1.Y
targetCFrameWithDefualtY = CFrame.new(P1.X, DefualtY, P1.Z)
targetPos = P1.Position
oldcframe = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
...
local tweenfunc = {}
tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/TweenSpeed, Enum.EasingStyle.Linear), {CFrame = targetCFrameWithDefualtY})
tween:Play()
...
local tweenfunc = {}
tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/TweenSpeed, Enum.EasingStyle.Linear), {CFrame = P1})
tween:Play()
...
for r, v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
table.insert(a, v.Name)
if table.find(a, "Null") then
table.remove(a, 1)
end
