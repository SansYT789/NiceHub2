...
local NoAttackAnimation, Fast_Attack, UseFastAttackPlayersAndMob = true, true, true
        ...
        pcall(function()
            ...
            if not hasFruit then
                ...
                elseif string.find(questTitle, NameMon) and questVisible then
                    ...
                    -- Di chuyển đến các điểm spawn của enemy nếu không tìm thấy enemy
                    for _, spawn in pairs(game:GetService("Workspace"):FindFirstChild("_WorldOrigin").EnemySpawns:GetChildren()) do
                        if string.find(spawn.Name, NameMon) then
                            if spawn:IsA("Part") then 
                                Tween(spawn.CFrame * MethodFarm)  -- Teleport đến điểm spawn
                            elseif spawn:FindFirstChild("HumanoidRootPart") then 
                                Tween(spawn.HumanoidRootPart.CFrame * MethodFarm)  -- Teleport đến enemy
                            end
                        end
                    end
                end
