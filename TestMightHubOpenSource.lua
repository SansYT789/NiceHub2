...
if placeId == 2753915549 then
distbyp = 1500
gQ = {Vector3.new(-7894.6201171875, 5545.49169921875, -380.246346191406),
Vector3.new(-4607.82275390625, 872.5422973632812, -1667.556884765625),
Vector3.new(61163.8515625, 11.759522438049316, 1819.7841796875),
Vector3.new(3876.280517578125, 35.10614013671875, -1939.3201904296875)}
elseif placeId == 4442272183 then
distbyp = 3500
gQ = {Vector3.new(-288.46246337890625, 306.130615234375, 597.9988403320312),
Vector3.new(2284.912109375, 15.152046203613281, 905.48291015625),
Vector3.new(923.21252441406, 126.9760055542, 32852.83203125),
Vector3.new(-6508.5581054688, 89.034996032715, -132.83953857422)}
elseif placeId == 7449423635 then
distbyp = 7000
gQ = {Vector3.new(-5058.77490234375, 314.5155029296875, -3155.88330078125),
...
function getSpawn(wtf)
    ...
    for i,v in pairs(game.Workspace._WorldOrigin.PlayerSpawns:FindFirstChild(tostring(plr.Team)):GetChildren()) do
...
until plr.Character.PrimaryPart.CFrame == p
plr.Character.Humanoid:ChangeState(15)
plr.Character:SetPrimaryPartCFrame(p)
wait(0.1)
game.Players.LocalPlayer.Character.Head:Destroy()
repeat task.wait() until plr.Character:FindFirstChild("Humanoid").Health <= 0
repeat task.wait()
plr.Character.PrimaryPart.CFrame = p
until plr.Character:FindFirstChild("Head") and plr.Character:FindFirstChild("Humanoid").Health > 0
wait(0.5)
end
...
function CheckBypassTrue(Distance,Portal,Spawn,P1)
...
for _, item in pairs(BlacklistItemTp) do
if plr.Backpack:FindFirstChild(item) or Char:FindFirstChild(item) then
return true
end
end
for _, item in pairs(NameFruitList) do
if plr.Backpack:FindFirstChild(item) or Char:FindFirstChild(item) then
return true
end
end
...
if hasBlacklistItem() then
return false
end

if calcpos(Portal,Spawn) > 500 and BypassTP and Distance > calcpos(Spawn, P1) and calcpos(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame, Spawn) > distbyp then
return true
else
return false
end
...
function Tween(P1)
if plr.Character:FindFirstChild("HumanoidRootPart") and plr.Character:FindFirstChild("Humanoid").Health > 0 then
local TweenSpeed = TweenSpeed or ChangeSpeed or 325
...
local Distance = calcpos(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame, P1)
if Distance <= 250 then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = P1
end

if Distance > calcpos(Portal, Spawn) and Distance > calcpos(Portal, P1) and calcpos(Portal,Spawn) <= 500 then
return request(Portal) 
end
if CheckBypassTrue(Distance, Portal,Spawn,P1) == true then
return BypassTp(Spawn)
end
...
repeat wait()
return AntiLowHealth(math.random(100, 750))
...
return AntiLowHealth(OldY)
end

pcall(function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X,DefaultY,game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
local bucu = game:GetService("TweenService")
local bucac = TweenInfo.new(Distance/TweenSpeed, Enum.EasingStyle.Linear)
tween = bucu:Create(game.Players.LocalPlayer.Character.HumanoidRootPart,bucac, {CFrame = targetCFrameWithDefaultY})
tween:Play()
...
CFrame.new(0, posY, -20)}
RandomCFrameIndex = math.random(1, #RandomCFrameChoices)
            ...
            if CheckMob(Mob) then
                ...
                if Mob and Mob:FindFirstChild("Humanoid") and Mob:FindFirstChild("HumanoidRootPart") and Mob.Humanoid.Health > 0 then
                    repeat
                        ...
                        Tween(Mob.HumanoidRootPart.CFrame * MethodFarm)
                        FarmPos, MonFarm = Mob.HumanoidRootPart.CFrame, Mob.Name
                        
                        if h["Mastery Farm"] and KillPercent and Mob.Humanoid.MaxHealth < 200000 then
                            local donandngu = Mob.Humanoid.Health <= Mob.Humanoid.MaxHealth * KillPercent / 100
                            _G.FastAttackNice = not donandngu
                            
                            if donandngu then
                                repeat
                                    gggggg, ggg2 = CheckSkillMastery()
                                    Tween(Mob.HumanoidRootPart.CFrame * MethodFarm)
                                    AimbotMobPosition, AimbotCheck = Mob.HumanoidRootPart.Position, true
                                    
                                    spawn(function()
                                        if h["TypeMasteryFarm"] == "Gun" and CheckSkillMastery() then
                                            EquipTool(gggggg)
                                            Click()
                                            game:GetService("Players").LocalPlayer.Character[gggggg].RemoteFunctionShoot:InvokeServer(Mob.HumanoidRootPart.Position, Mob.HumanoidRootPart)
                                        end
                                    end)
                                    
                                    if string.find(gggggg, "Dough") then Click() end
                                    if gggggg and ggg2 then
                                        EquipTool(gggggg)
                                        KeyPress(ggg2)
                                        task.wait(0.2)
                                    end
                                until not donandngu or not Mob or Mob.Humanoid.Health <= 0 or CheckIsRaiding()
                                
                                AimbotCheck, AimbotMobPosition = false, nil
                            end
                        end
                    until not Mob or Mob.Humanoid.Health <= 0 or CheckIsRaiding()
                    _G.FastAttackNice, AimbotCheck, AimbotMobPosition = false, false, nil
                end
            elseif c2 then
                local MobSLCSpawnssss = {}
                if string.find(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()[1].Name, "Lv.") then
                    MobSLCSpawnssss = Mob
                else
                    for _, v in pairs(Mob) do
                        table.insert(MobSLCSpawnssss, tostring(v:gsub(" %pLv. %d+%p", "")))
                    end
                end
                
                for _, v in pairs(MobSLCSpawnssss) do
                    local MobSpawn = game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:FindFirstChild(v)
...
local listfastattack = {"Super Fast (Risk)","Fast","0.15","0.175","0.2","0.3","0.4"}
ST:AddDropdown({
    ...
    Save = true,
	Callback = function(Value)
_G.FastAttackDelayChosen = Value

if _G.FastAttackDelayChosen == "Super Fast (Risk)" then
_G.FastAttackDelay = 0
elseif _G.FastAttackDelayChosen == "Fast" then
_G.FastAttackDelay = 0.1
else
_G.FastAttackDelay = _G.FastAttackDelayChosen
end
	end    
})
