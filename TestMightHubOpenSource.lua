...
CbFw2.activeController.focusStart = 1655503339.0980349
...
until (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude > 100 or v.Name ~= MonFarm or not v.Parent or v.Humanoid.Health <= 0
end
end
end
end)
