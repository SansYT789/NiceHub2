...
if BypassTP and Bucac(P1, HMRP) > 2500 then
return "Bypass"
else
return "Not Bypass"
end
...
function Tween(P1)
if not plr.Character:FindFirstChild("HumanoidRootPart") and not plr.Character:FindFirstChild("Humanoid").Health > 0 then
return
end
pcall(function()
