...
print("Loaded Progress: "..tostring(game:IsLoaded()))
...
print("Your Teams: "..tostring(game.Players.LocalPlayer.Team))
...
print("Delete Particle Death And Spawn")
...
print("Loaded CFrame: "..tostring(MethodFarm))
...
print("Load Melee: "..tostring(SelectWeapon))
...
print("Enemy Hitbox Test: "..tostring(enemy:FindFirstChild("HumanoidRootPart").Size))
enemy.HumanoidRootPart.CanCollide = false
enemy.HumanoidRootPart.Transparency = 0
print("Enemy Hitbox Transparency Test: "..tostring(enemy:FindFirstChild("HumanoidRootPart").Transparency))
enemy.HumanoidRootPart.CFrame = CFrame.new(MonPos.X,MonPos.Y,MonPos.Z)
print("Enemy Tp ở đâu thg ngáo: "..tostring(enemy:FindFirstChild("HumanoidRootPart").CFrame))
print("Bú cặc bring true")
print("Enemy HumanoidRootPart: "..tostring(enemy:FindFirstChild("HumanoidRootPart")))

enemy.Humanoid:ChangeState(11)
print("Enemy GetState: "..tostring(enemy:FindFirstChild("Humanoid"):GetState()))
...
Tween(CFrameQ)
print("Get Quest: "..tostring(NameQuest))
...
MonName, MonPos, NeedAttacking = enemy.Name, enemy.HumanoidRootPart.CFrame, true
until not _G.AutoKaitun or not enemy.Parent or enemy.Humanoid.Health <= 0 or not questVisible
MonName, MonPos, NeedAttacking = nil, nil, false
end
end
end
...
print(MonName)
print(MonPos)
print("Auto Farm: "..tostring(_G.AutoKaitun))