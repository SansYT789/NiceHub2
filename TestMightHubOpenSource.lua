...
function BypassTp(p)
pcall(function()
if (p.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 1500 then
        ...
        pcall(function()
            for _, v in pairs(game.Workspace.Enemies:GetChildren()) do
                ...
                if enemyHumanoid and enemyRoot then
                    ...
                    if not string.find(v.Name, "Boss") and v.Name == MonFarm and distance <= 450 then
                        enemyRoot.CFrame = FarmPos
                        enemyRoot.CanCollide = false
                        enemyRoot.Transparency = 0
                        enemyRoot.Size = Vector3.new(1, 1, 1)

                        -- Cập nhật trạng thái humanoid của enemy
