...
for r, v in next, game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills[MasteryWeapon]:GetChildren() do
if v:IsA("Frame") then
...
for r, v in pairs(SkillsSelected) do
    if v then
...
M:AddDropdown({
    ...
    Save = true,
	Callback = function(Value)
SkillsSelected[Value] = not SkillsSelected[Value]
RealSkillSelected = {}
for r, v in pairs(SkillsSelected) do
if v then
table.insert(RealSkillSelected, r)
