...
function CheckBypassTrue(Portal,Spawn,P1)
...
if BypassTP then
if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(BlacklistItemTp) or game:GetService("Players").LocalPlayer.Character:FindFirstChild(BlacklistItemTp) or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(NameFruitList) or game:GetService("Players").LocalPlayer.Character:FindFirstChild(NameFruitList) then
if calcpos(Portal,Spawn) > 500 and Distance > calcpos(Spawn, P1) and calcpos(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame, Spawn) > distbyp then
return false
else
return false
end
...
if not game:GetService("Players").LocalPlayer.Character.Head:FindFirstChild("MightHubTween") then
local Noclip = Instance.new("BodyVelocity")
Noclip.Name = "MightHubTween"
Noclip.Parent = game:GetService("Players").LocalPlayer.Character.Head
...
if CheckBypassTrue(Portal,Spawn,P1) == true then
return BTP(Spawn)
end
...
tween:Cancel()
game:GetService("Players").LocalPlayer.Character.Head:FindFirstChild("MightHubTween"):Destroy()
end
