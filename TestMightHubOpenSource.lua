...
for _, item1 in pairs(NameFruitList) do
if plr.Backpack:FindFirstChild(item1) or Char:FindFirstChild(item1) then
return true
end
end
return false
...
if CheckBypassTrue(Distance, Portal, Spawn, P1) == "Bypass" then
BypassTp(Spawn)
end
...
_G.FastAttackDelay = 0.000005
elseif _G.FastAttackDelayChosen == "..." then
