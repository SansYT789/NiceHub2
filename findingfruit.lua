...
Fruit:SetPrimaryPartCFrame(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
smoothRainbowTransition(Fruit)

local FruitHandle = Instance.new("Part")
FruitHandle.Name = "Handle"
FruitHandle.Size = Vector3.new(2.5, 2.5, 2.5)
FruitHandle.Color = Color3.fromRGB(255, 165, 0)
FruitHandle.Anchored = true
FruitHandle.Parent = Fruit

Fruit.PrimaryPart = FruitHandle -- Thiết lập PrimaryPart cho Model
Fruit.Touched:Connect(onTouch)

-- Thiết lập thuộc tính cho Fruit
Fruit.CanCollide = true
Fruit:SetPrimaryPartCFrame(FruitHandle.CFrame)
