...
if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand") or game:GetService("ReplicatedStorage"):FindFirstChild("Ship Deckhand") then
MMon = "Ship Deckhand"
MPos = CFrame.new(921.12365722656, 125.9839553833, 33088.328125)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer") or game:GetService("ReplicatedStorage"):FindFirstChild("Ship Engineer") then
MMon = "Ship Engineer"
MPos = CFrame.new(886.28179931641, 40.47790145874, 32800.83203125)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward") or game:GetService("ReplicatedStorage"):FindFirstChild("Ship Steward") then
MMon = "Ship Steward"
MPos = CFrame.new(943.85504150391, 129.58183288574, 33444.3671875)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer") or game:GetService("ReplicatedStorage"):FindFirstChild("Ship Officer") then
MMon = "Ship Officer"
...
if game:GetService("Workspace").Enemies:FindFirstChild("Water Fighter") or game:GetService("ReplicatedStorage"):FindFirstChild("Water Fighter") then
MMon = "Water Fighter"
MPos = CFrame.new(-3262.9301757813, 298.69036865234, -10552.529296875)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Sea Soldier") or game:GetService("ReplicatedStorage"):FindFirstChild("Sea Soldier") then
MMon = "Sea Soldier"
...
if First_Sea then
if game:GetService("Workspace").Enemies:FindFirstChild("Military Spy") or game:GetService("ReplicatedStorage"):FindFirstChild("Military Spy") then
MMon = "Military Spy"
MPos = CFrame.new(-5787.00293, 75.8262634, 8651.69922, 0.838590562, 0, -0.544762194, 0, 1, 0, 0.544762194, 0, 0.838590562)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Military Soldier") or game:GetService("ReplicatedStorage"):FindFirstChild("Military Soldier") then
MMon = "Military Soldier"
MPos = CFrame.new(-5369.0004882813, 61.24352645874, 8556.4921875)
SP = "Default"
end
elseif Second_Sea then
if game:GetService("Workspace").Enemies:FindFirstChild("Magma Ninja") or game:GetService("ReplicatedStorage"):FindFirstChild("Magma Ninja") then
MMon = "Magma Ninja"
MPos = CFrame.new(-5461.8388671875, 130.36347961426, -5836.4702148438)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate") or game:GetService("ReplicatedStorage"):FindFirstChild("Lava Pirate") then
MMon = "Lava Pirate"
...
if game:GetService("Workspace").Enemies:FindFirstChild("Royal Squad") or game:GetService("ReplicatedStorage"):FindFirstChild("Royal Squad") then
MMon = "Royal Squad"
MPos = CFrame.new(-7654.2514648438, 5637.1079101563, -1407.7550048828)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Royal Soldier") or game:GetService("ReplicatedStorage"):FindFirstChild("Royal Soldier") then
MMon = "Royal Soldier"
...
if Third_Sea then
if game:GetService("Workspace").Enemies:FindFirstChild("Fishman Raider") or game:GetService("ReplicatedStorage"):FindFirstChild("Fishman Raider") then
MMon = "Fishman Raider"
MPos = CFrame.new(-10553.268554688, 521.38439941406, -8176.9458007813)
SP = "Default"
elseif game:GetService("Workspace").Enemies:FindFirstChild("Fishman Captain") or game:GetService("ReplicatedStorage"):FindFirstChild("Fishman Captain") then
...
local MoonTextId = CheckMoonTexturesId()
...
if _G.AutoLevel or _G.AutoAllBoss or _G.OneClickRaid or _G.AutoNonCuDai3M or _G.AutoVongHoaBuffBan or _G.AutoSuperBucuMaxPro or _G.AutoSerpentBow or _G.AutoElectricClaw or _G.AutoSharkJinBeNguDot or _G.AutoRongLuaSoaiCa or _G.AutoDeathNgonLao or _G.AutoRainbowHaki or _G.AutoDarkCoat or _G.AutoTrains or _G.AutoLevelNoQuest or _G.AutoNear or _G.AutoBone or _G.AutoHallowScythe or _G.AutoCakePrince or _G.AutoDoughKing or _G.AutoChest or _G.AutoChestBypass or _G.AutoBoss or _G.AutoMaterial or _G.AutoEctoplasm or _G.AutoFruitMastery or _G.AutoGunMastery or _G.TweenFruit or _G.AutoCompleteTrialV4 or _G.AutoKillPlayerAfterTrial or _G.TpToMirage or _G.TpToAFD or _G.TpGear or _G.AutoSaber or _G.AutoPole or _G.AutoSawSword or _G.AutoCoolShades or _G.AutoItemsPrison or _G.AutoSecondSea or _G.AutoBartilo or _G.AutoThirdSea or _G.AutoFactory or _G.AutoKillSwan or _G.AutoRengoku or _G.AutoKenV1 or _G.AutoEliteHunter or _G.AutoTushita or _G.RaidCastle or _G.AutoCanvander or _G.AutoTwinHook or _G.AutoKillDummy or _G.AutoDarkDagger or _G.AutoBuddySword or _G.TpToKitsune or _G.AutoCollectAzureEmber or _G.AutoNextIsland or _G.AutoLaw or _G.TeleportPlayers or _G.AutoKillPlayers or _G.TeleportIsland or _G.TeleportSeaBeast or _G.AutoSeaEvent or _G.AutoKenV2 or _G.AutoGhoul or _G.AutoCyborg then
for i,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
...
----------------------------------------------------------------------------
-- Gui Hub
local Window = OrionLib:MakeWindow({Name = "Might Hub | discord.gg/E9vgWrUWP2", HidePremium = false, IntroText = "Loading Gui...", SaveConfig = true, ConfigFolder = "MightHubConfig"})
...
if CheckMoonTexturesId() == moon5 then
require(game.ReplicatedStorage.Notification).new("<Color=White>Full Moon!!!<Color=/>"):Display()
elseif CheckMoonTexturesId() == moon4 then
require(game.ReplicatedStorage.Notification).new("<Color=White>Near Full Moon!<Color=/>"):Display()
end
wait(.2)
require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Script Made By MinGht(Discord)<Color=/>"):Display()
wait(.7)
require(game.ReplicatedStorage.Notification).new("<Color=Blue>Enjoy My Script!<Color=/>"):Display()
wait(.14)
require(game.ReplicatedStorage.Notification).new("<Color=Blue>Thanks To Choose This Scripts!<Color=/>"):Display()
wait(.19)
end)
...
if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and v.Humanoid.Health > 0 and v:FindFirstChild("HumanoidRootPart") then
repeat wait()
AutoHaki()
EquipTool(SelectWeapon)
v.HumanoidRootPart.CanCollide = false
...
FarmPos = v.HumanoidRootPart.CFrame
MonFarm = v.Name
until v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart") or not _G.AutoDoughKing or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince")
end
end
else
...
elseif game:GetService("Workspace").Enemies:FindFirstChild("Dough King") or game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") then
...
M:AddButton({
	Name = "Refresh Boss",
	Callback = function()
SelectedBoss:Refresh(Ngonlao,true)
NameBossTable = {"The Gorilla King","Bobby","Yeti","Mob Leader","Vice Admiral","Warden","Chief Warden","Swan","Magma Admiral","Fishman Lord","Wysper","Thunder God","Cyborg","Saber Expert","Diamond","Jeremy","Fajita","Don Swan","Smoke Admiral","Cursed Captain","Darkbeard","Order","Awakened Ice Admiral","Tide Keeper","Factory","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen","Dough King"}
for i,v in pairs(game.ReplicatedStorage:GetChildren()) do
if table.find(NameBossTable, v.Name) then
table.insert(Ngonlao,v.Name)
SelectedBoss:Set(Ngonlao)
end
end
  	end    
})
...
v.HumanoidRootPart.CanCollide = false
Click()
until not _G.AutoBoss or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
end
end
end
if game:GetService("ReplicatedStorage"):FindFirstChild(BossMon) then
...
BTP(v.HumanoidRootPart.CFrame * CFrame.new(0,posY,0))
...
M:AddToggle({
	Name = "Auto Farm Material [Current Test]",
	Default = false,
...
pcall(function()
local DarkbeardPos = CFrame.new(3677.08203125, 62.751937866211, -3144.8332519531)
if game:GetService("Workspace").Enemies:FindFirstChild("Don Swan") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
IQ:AddToggle({
	Name = "Auto Observation Hop",
	Default = false,
	Flag = "AutoObservationHop",
    Save = true,
	Callback = function(Value)
	_G.AutoKenV1Hop = Value
	end    
})
...
until not _G.AutoKenV1 or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
else
repeat task.wait()
game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate").HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)
wait(1)
if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoKenV1Hop then
game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
end
until not _G.AutoKenV1 or game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
end
else
...
until game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") or not _G.AutoKenV1
end
end)
end
end)
...
IQ:AddToggle({
	Name = "Auto Pilot Helmet",
	Default = false,
	Flag = "AutoPilotHelmet",
    Save = true,
	Callback = function(Value)
	_G.AutoNonCuDai3M = Value
	end    
})

spawn(function()
while wait() do
if _G.AutoNonCuDai3M then
pcall(function()
local PilotHelmetPos = CFrame.new(-1027.6512451172, 92.404174804688, 6578.8530273438)
if game:GetService("Workspace").Enemies:FindFirstChild("Stone") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if v.Name == "Stone" then
if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
...
Click()
sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
until not _G.AutoNonCuDai3M or not v.Parent or v.Humanoid.Health <= 0
end
end
end
else
if BypassTP then
if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - PilotHelmetPos.Position).Magnitude > 1500 then
BTP(PilotHelmetPos)
elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - PilotHelmetPos.Position).Magnitude < 1500 then
Tween(PilotHelmetPos)
end
else
Tween(PilotHelmetPos)
end
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Stone").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
end
end
end)
end
...
IQ:AddToggle({
    ...
    Save = true,
	Callback = function(Value)
	_G.AutoVongHoaBuffBan = Value
	end    
})

spawn(function()
while wait() do
if _G.AutoVongHoaBuffBan then
pcall(function()
local KiloBossPos = CFrame.new(2764.2233886719, 432.46154785156, -7144.4580078125)
if game:GetService("Workspace").Enemies:FindFirstChild("Kilo Admiral") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if v.Name == "Kilo Admiral" then
if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
...
Click()
sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
until not _G.AutoVongHoaBuffBan or not v.Parent or v.Humanoid.Health <= 0
end
end
end
else
if BypassTP then
if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - KiloBossPos.Position).Magnitude > 1500 then
BTP(KiloBossPos)
elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - KiloBossPos.Position).Magnitude < 1500 then
Tween(KiloBossPos)
end
else
Tween(KiloBossPos)
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Kilo Admiral").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
end
end
end)
end
...
pcall(function()
local NuHoangDucBoPos = CFrame.new(5543.86328125, 668.97399902344, 199.0341796875)
if game:GetService("Workspace").Enemies:FindFirstChild("Island Empress") or game:GetService("Workspace").Enemies:FindFirstChild("Island Empress") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
OrionLib:MakeNotification({
	Name = "Notifying",
	Content = "You already have Soul Guitar so it doesn't work please turn it off!",
	Image = "rbxassetid://4483345998",
	Time = 8
})
end
...
pcall(function()
while wait() do 
if _G.AutoSuperBucuMaxPro then
...
if game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 then
local a = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyElectricClaw", true)
if a == 4 then
local a = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyElectricClaw","Start")
if a == nil then
...
IQ:AddToggle({
    ...
    Save = true,
	Callback = function(Value)
_G.AutoDeathNgonLao = Value
if _G.AutoDeathNgonLao then
CommFuckNgonLao("F_", "BuyBlackLeg")
end
	end    
})
...
until (CFrame.new(6371.2001953125, 296.63433837890625, -6841.18115234375).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.AutoDeathNgonLao
...
if BypassTP then
if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.CFrame.Position).Magnitude > 1500 then
BTP(v.HumanoidRootPart.CFrame * CFrame.new(0,posY,0))
elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.CFrame.Position).Magnitude < 1500 then
Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,posY,0))
end
else
Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,posY,0))
...
until not v.Parent or v.Humanoid.Health <= 0 or not _G.AutoDeathNgonLao or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Library Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Library Key")
end
end
else
if game:GetService("ReplicatedStorage"):FindFirstChild("Awakened Ice Admiral") then
Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Awakened Ice Admiral").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
end
end
end
end
...
IQ:AddToggle({
	Name = "Auto SharkmanKarate",
	Default = false,
	Flag = "AutoSharkmanKarate",
    Save = true,
	Callback = function(Value)
_G.AutoSharkJinBeNguDot = Value
if _G.AutoSharkJinBeNguDot then
CommFuckNgonLao("F_", "BuySharkmanKarate")
end
	end    
})
...
until (CFrame.new(-2604.6958,239.432526,-10315.1982,0.0425701365,0,-0.999093413,0,1,0,0.999093413,0,0.0425701365).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.AutoFullySharkManKarate
...
IQ:AddToggle({
    ...
    Save = true,
	Callback = function(Value)
_G.AutoRongLuaSoaiCa = Value
if _G.AutoRongLuaSoaiCa then
CommFuckNgonLao("F_", "BlackbeardReward", "DragonClaw", "2")
end
	end    
})
...
function GetNameMeleeEquip(NgonLao)
for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
if v:IsA("Tool") then
if v.ToolTip == NgonLao then
EquipTool(v.Name)
end
end
end
...
GetNameMeleeEquip("Melee")
KeyPress("Z")
KeyPress("X")
KeyPress("C")
KeyPress("V")
wait(0.05)
GetNameMeleeEquip("Blox Fruit")
KeyPress("Z")
KeyPress("X")
KeyPress("C")
KeyPress("V")
wait(0.05)
GetNameMeleeEquip("Sword")
KeyPress("Z")
KeyPress("X")
KeyPress("C")
KeyPress("V")
wait(0.05)
GetNameMeleeEquip("Gun")
KeyPress("Z")
KeyPress("X")
KeyPress("C")
KeyPress("V")
...
pcall(function()
local MonSESpawnFish = false
local MonSESpawnSB = false
...
if MonSESpawnSB or MonSESpawnFish then
TweenBoat(TargetCFrameFix * CFrame.new(0,1500,0))
else
...
wait(0.25)
MyShip.VehicleSeat.CFrame = HMRP.CFrame * CFrame.new(0,0,10)
end
...
elseif not MonSESpawnSB or not MonSESpawnFish then
...
if _G.SafeModeHealthSeaEvent then
if HM.Health <= 3500 then
Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,900,0))
else
...
SE:AddToggle({
	Name = "If Boat Destroy Then Auto Reset [Coming Soon]",
	Default = false,
	Flag = "ResetWhenBoatDestroy",
    Save = true,
	Callback = function(Value)
	_G.AutoResetWhenBoatDestroy = Value
	end    
})
...
shrineActive = kitsuneIsland:FindFirstChild("ShrineActive")
...
local CheckRaceV4Number = STA:AddLabel("Race V4 Number Status")

spawn(function()
while wait() do
if Third_Sea then
pcall(function()
CheckRaceV4Number:Set("Race V4 Number Status : "..game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("UpgradeRace","Check"))
end)
end
end
end)
...
v.Humanoid.Health = 0
v.HumanoidRootPart.CanCollide = false
until not _G.OneClickRaid or not v.Parent or v.Humanoid.Health <= 0
end
end
end
end)
...
P:AddButton({
    Name = "Reset Dropdown",
    Callback = function()
SelectedPlayers:Refresh(Playerslist,true)
for i,v in pairs(game:GetService("Players"):GetChildren()) do
table.insert(Playerslist,v.Name)
SelectedPlayers:Set(Playerslist)
end
      end     
})
...
repeat wait()
Tween(game:GetService("Players")[_G.SelectPlayers].Character.HumanoidRootPart.CFrame)
...
local listfastattack = {"0.5","0.4","0.3","0.2","0.15","0.1","0","0.05","0.025","0.01","0.005","0.0025"}
