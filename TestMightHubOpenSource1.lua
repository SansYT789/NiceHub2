...
while task.wait() do
pcall(function()
if Options.RaidEspCollectFruitToggle.Value or Options.MainFarmStartFarmToggle.Value or Options.RaidEspNextRaidIslandToggle.Value or Options.SubFarmOpenHakiPadToggle.Value or Options.SubFarmEliteToggle.Value or Options.SubFarmSpawnKillRipIndraToggle.Value then
if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("MightHubTween") then
local Noclip = Instance.new("BodyVelocity", game.Players.LocalPlayer.Character.HumanoidRootPart)
