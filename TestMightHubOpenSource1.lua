...
while task.wait() do
pcall(function()
if HackerNoclipFly or Options.MainFarmStartFarmToggle.Value or Options.SubFarmEliteToggle.Value or Options.SubFarmOpenHakiPadToggle.Value or Options.SubFarmSpawnKillRipIndraToggle.Value or Options.RaidEspNextRaidIslandToggle.Value or Options.RaidEspCollectFruitToggle.Value then
