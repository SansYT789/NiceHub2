...
local Tabs = {
    ...
    StackFarm = Window:AddTab({ Title = "Stack Auto Farm", Icon = "settings" }),
...
local SelectWeaponDropdown = Tabs.MainFarm:AddDropdown("WeaponChoseDropdown", {
Title = "Select Weapon",
Values = WeaponChose,
Multi = false,
Default = 1,
...
NeedAttacking = true
sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
until not Options.MainFarmStartFarmToggle.Value or not enemy.Parent or enemy.Humanoid.Health <= 0 or not questVisible
HackerNoclipFly = false
NeedAttacking = false
end
end
...
spawn(function()
while task.wait() do
if Options.StackFarmFruitToggle.Value and not hasFruit then
pcall(function()
for _, fruit in pairs(game:GetService("Workspace"):GetChildren()) do
if string.find(fruit.Name, "Fruit") then
Tween(fruit.Handle.CFrame)
...
spawn(function()
while task.wait() do
if Options.StackFarmEliteToggle.Value and not hasElite then
pcall(function()
if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Urban") then
if game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
...
NeedAttacking = true
sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
until hasElite or elite.Humanoid.Health <= 0 or not elite.Parent or not Options.StackFarmEliteToggle.Value
HackerNoclipFly = false
NeedAttacking = false
end
end
