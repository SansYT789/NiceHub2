...
while task.wait() do
pcall(function()
if HackerNoclipFly or Options.RaidEspCollectFruitToggle.Value or Options.MainFarmStartFarmToggle.Value or Options.RaidEspNextRaidIslandToggle.Value or Options.SubFarmOpenHakiPadToggle.Value or Options.SubFarmEliteToggle.Value or Options.SubFarmSpawnKillRipIndraToggle.Value then
