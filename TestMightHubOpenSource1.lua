...
if CheckIsRaiding() and hasBlacklistItem() then return end

local distance = (humanoidRootPart.Position - P1.Position).Magnitude
...
humanoid.Health = 0
task.wait(0.5)
distance = (humanoidRootPart.Position - P1.Position).Magnitude
until distance < 2500 and humanoid.Health > 0
end
end)
end
