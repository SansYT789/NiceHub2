...
until not Options.MainFarmStartFarmToggle.Value or not enemy.Parent or enemy.Humanoid.Health <= 0
HackerNoclipFly = false
NeedAttacking = false
end
end
...
CancelTween(Options.SubFarmOpenHakiPadToggle.Value)
end
end
end)
...
local SelectChipDropdown = Tabs.Settings:AddDropdown("RaidEspSelectChipDropdown", {
