...
function BypassTp(P)
pcall(function()
if not game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") or not game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
return
end

if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - P.Position).Magnitude > 2500 then
repeat wait(0.5)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = P
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = P
until (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - P.Position).Magnitude < 2500 and game.Players.LocalPlayer.Character.Humanoid.Health > 0
end
...
function TweenToTarget(P1, Distance, Speed)
DefaultY = P1.Y
TargetY = P1.Y
targetCFrameWithDefaultY = CFrame.new(P1.X, DefaultY, P1.Z)
b1 = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, DefaultY, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
if SameY and (b1.Position - targetCFrameWithDefaultY.Position).Magnitude > 5 then
...
game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / Speed, Enum.EasingStyle.Linear), 
...
function CheckAndTeleport(P1)
    if Distance > 2500 and BYPASSTELEPORT and not CheckIsRaiding() and not hasBlacklistItem() then
        BypassTp(P1) -- Teleport khi quá xa
    else
        return (P1.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    end
end

function Tween(P1)
pcall(function()
if not (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character.Humanoid.Health > 0) then return end
if not P1 then return end
local Distance = CheckAndTeleport(P1)
local TweenSpeed = Distance < 500 and 750 or (Distance < 750 and 450 or (ChangeSpeed or 300))
...
TweenToTarget(P1, Distance, TweenSpeed)
end)
end
...
if not game:GetService("Workspace")[_WorldOrigin"].EnemySpawns:FindFirstChild(NameMon) then
Tween(CFrameMon)
end
