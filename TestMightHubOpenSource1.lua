...
function Tween(P1)
if not (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character.Humanoid.Health > 0) then
return
end
...
b1 = CFrame.new(HumanoidRootPart.CFrame.X,DefaultY,HumanoidRootPart.CFrame.Z)
...
if BypassTp then
if (HumanoidRootPart.Position - P1.Position).Magnitude > 2500 and not CheckIsRaiding() then
if not hasBlacklistItem() then
pcall(function()
if tween then
tween:Cancel()
end
...
HumanoidRootPart.CFrame = CFrame.new(HumanoidRootPart.CFrame.X, OldY, HumanoidRootPart.CFrame.Z)
end

if SameY and (b1.Position - targetCFrameWithDefaultY.Position).Magnitude > 5 then
HumanoidRootPart.CFrame = CFrame.new(HumanoidRootPart.CFrame.X, DefaultY, HumanoidRootPart.CFrame.Z)
tween = game:GetService("TweenService"):Create(
HumanoidRootPart, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), 
...
HumanoidRootPart.CFrame = CFrame.new(HumanoidRootPart.CFrame.X,TargetY,HumanoidRootPart.CFrame.Z)
else
tween = game:GetService("TweenService"):Create(
HumanoidRootPart, 
