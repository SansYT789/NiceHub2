...
function Tween(P1)
if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
if not P1 then
return
end
...
if SameY and (CFrame.new(HumanoidRootPart.CFrame.X,P1.Y,HumanoidRootPart.CFrame.Z).Position - CFrame.new(P1.X, P1.Y, P1.Z).Position).Magnitude > 5 then
HumanoidRootPart.CFrame = CFrame.new(HumanoidRootPart.CFrame.X, P1.Y, HumanoidRootPart.CFrame.Z)
tween = game:GetService("TweenService"):Create(
HumanoidRootPart, 
TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), 
{CFrame = CFrame.new(P1.X, P1.Y, P1.Z)})
tween:Play()
