...
local TpSeaDropdown = Tabs.Settings:AddDropdown("IslandsTpWorldSeaDropdown", {
...
Window:Dialog({
Title = "Are you sure you want to teleport to " .. Value .. "?",
Content = "Click Confirm or Cancel to execute the request.",
...
local Toggle = Tabs.Settings:AddToggle("SettingsWalkOnWaterToggle", {Title = "Walk On Water", Default = false })
spawn(function()
while task.wait() do
pcall(function()
...
local Toggle = Tabs.Settings:AddToggle("SettingsDeleteLavaToggle", {Title = "Delete Lava", Default = false })
spawn(function()
while task.wait() do
pcall(function()
if Options.SettingsDeleteLavaToggle.Value then
